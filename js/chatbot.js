document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMessage(text, sender, showMenu = false) {
        ...
        if (showMenu && sender === 'bot') {
            ...
            // Elimina el menú anterior si existe para evitar duplicados
            ...
            MENU_AUTOMATICO.forEach(option => {
                ...
                // Usamos una función anónima para que handleSend se ejecute con el texto
    ...
    function encontrarRespuesta(input) {
        ...
        // Si el input coincide directamente con una opción del menú
    ...
    function handleSend(text = null) {
        ...
        setTimeout(() => {
            // El menú automático se muestra después de cada respuesta del bot
    ...
    // Al cargar la página, limpia el mensaje inicial de bienvenida y muestra el menú
    setTimeout(() => {
        if (chatBody.childElementCount > 0) {
            chatBody.innerHTML = ''; // Limpia el mensaje inicial estático del HTML
        }
